...
5. (Optional) Enter your AppKey and AppSecret if you have them from the open platform

### Getting AppKey and AppSecret (Optional)
...
Note: Basic functionality works with just username and password. AppKey and AppSecret are optional.
